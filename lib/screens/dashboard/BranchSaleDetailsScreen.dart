...
class BranchSaleDetailsScreen extends StatefulWidget {
  final String branchName;
  final String branchId;
  final String period; // 'today' or 'yesterday'
  final int saleCount;

  const BranchSaleDetailsScreen({
    super.key,
  ...
  @override
  State<BranchSaleDetailsScreen> createState() =>
      _BranchSaleDetailsScreenState();
}

class _BranchSaleDetailsScreenState extends State<BranchSaleDetailsScreen> {
  ...
  String get _cacheKey => 'branch_sale_${widget.branchId}_${widget.period}';
  ...
  Future<void> _loadDetails() async {
    ...
    try {
      ...
      final data = await ApiService.getBranchSaleDetails(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: _buildSaleCard(_rows[index], index),
              );
            },
          ),
        ),
