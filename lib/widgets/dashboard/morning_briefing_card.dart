...
class _MorningBriefingCardState extends State<MorningBriefingCard> {
  bool _loading = true;
  bool _cardExpanded = false; // controls open/close of entire card body
  bool _expanded = false;   // controls show more/fewer alerts inside card
  String _error = '';
